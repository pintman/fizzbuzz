...
#+BEGIN_SRC python -n :results output :exports both
  ...
  class FizzBuzzHandler(socketserver.BaseRequestHandler):
      def handle(self):
          ...
          print("received:", i, "answer:", answer)
...
#+begin_example
sending 0
received: 0 answer: fizzbuzz
sending 1
received: 1 answer: 1
sending 2
received: 2 answer: 2
sending 3
received: 3 answer: fizz
sending 4
received: 4 answer: 4
sending 5
received: 5 answer: buzz
sending 6
received: 6 answer: fizz
sending 7
received: 7 answer: 7
sending 8
received: 8 answer: 8
sending 9
received: 9 answer: fizz
sending 10
received: 10 answer: buzz
sending 11
received: 11 answer: 11
sending 12
received: 12 answer: fizz
sending 13
received: 13 answer: 13
sending 14
received: 14 answer: 14
sending 15
received: 15 answer: fizzbuzz
sending 16
received: 16 answer: 16
sending 17
received: 17 answer: 17
sending 18
received: 18 answer: fizz
sending 19
received: 19 answer: 19
#+end_example
...
#+BEGIN_SRC plantuml :file doc/fizzbuzz-aktdiag.png
@startuml
start
:zahl = 1;
while (zahl <= 20) is (ja)
...
#+BEGIN_SRC plantuml :file doc/fizzbuzz-seqdiag.png
@startuml
...
#+BEGIN_SRC python -n :results output :exports both
  ...
  class FizzbuzzMqttClient:
      def __init__(self, server="iot.eclipse.org", port=1883):
          """Create a client and connect to  the eclipse test Broker by default."""
          self._topic = "/fizzbuzz/"
      ...
      def publish(self, payload):
          self.client.publish(self._topic, payload)


  #### Client 1 ####
          
  # Start thread in background that responds to messages
  mqttc1 = FizzbuzzMqttClient()
  th1 = threading.Thread(target=mqttc1.start, daemon=True)
  th1.start()

  #### Client 2 ####

  print("[start publishing]")
  mqttc2 = FizzbuzzMqttClient()
  for i in range(1,21):
      mqttc2.publish(i)
