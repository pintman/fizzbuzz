...
#+BEGIN_SRC python -n :results output :exports both :cache yes
  ...
  class FizzBuzz:
      def fizzbuzz(self, i):
          """Die ist ein Kommentar,der einen Test enthält. Unter Python nennt
          man dies einen doctest.
...
#+RESULTS[2b9ac0e47c62d186c289d72c26cfd5fd8f5b2d03]:
#+begin_example
**********************************************************************
File "<stdin>", line 22, in __main__.FizzBuzz.fizzbuzz
Failed example:
    fb.fizzbuzz(12)
Expected:
    12
