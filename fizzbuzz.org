...
#+BEGIN_SRC plantuml :file doc/fizzbuzz-mqtt.png
@startuml
client1 -> Broker: connect()
client2 -> Broker: connect()

client1 -> Broker: subscribe("/fizzbuzz/")
client2 -> Broker: publish("/fizzbuzz/", "2")
Broker -> client1: on_message(2)
client1 -> client1: print(2)

client2 -> Broker: publish("/fizzbuzz/", "3")
Broker -> client1: on_message(3)
client1 -> client1: print("fizz")

client2 -> Broker: publish("/falscher_kanal/", "2")
