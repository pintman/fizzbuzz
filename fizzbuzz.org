...
#+BEGIN_SRC python -n :results output
  ...
  class NumberFizzBuzzerAusgabe(FizzBuzzerAusgabe): # Unterklasse(Oberklasse)
      def __init__(self, n):
...
#+BEGIN_SRC python -n :results output :exports both :cache yes
  ...
  class FizzBuzzSpiel:
      """Ein Klasse für das FizzBuzzSpiel."""
...
#+RESULTS[227b7460276203ab5534ca4786baa3b6f5ab2e7d]:
#+begin_example
Help on class FizzBuzzSpiel in module __main__:

class FizzBuzzSpiel(builtins.object)
 |  Ein Klasse für das FizzBuzzSpiel.
 |  
 |  Methods defined here:
 |  
...
jedem Mausklick wird eine Zahl, "fizz", "buzz" oder "fizzbuzz" auf dem
Ball angezeigt.
...
#+BEGIN_SRC python -n
  ...
  class FizzBuzzGame:
      def __init__(self):
          ...
          size = self.width, self.height = 320, 240
          self.screen = pygame.display.set_mode(size)

          self.ball = pygame.image.load("doc/ball.gif")
      ...
      def start_game_loop(self):
          ...
          while True:
              for event in pygame.event.get():
                  ...
                  # copy from image ball to the given position
                  self.screen.blit(self.ball, self.ballrect)
                  fontsurf = self.font.render(str(fb_result), False, (0,255,0))
                  self.screen.blit(fontsurf, self.ballrect)
                  # flip the buffer
                  pygame.display.flip()
...
Die in dem Image referenzierte Datei =fizzbuzz_docker.py= hat
folgenden Inhalt.

#+INCLUDE: "fizzbuzz_docker.py" src python -n

Der Container can mit diesem Script nun gebaut werden.
...
der Container nach Beendigung der Ausführung direkt gelöscht. Das oben
erstellte Image bleibt jedoch erhalten.
...
#+RESULTS[3459ab19f0fe7638d082a9bbf91d607b3cb0a33d]:
: Untagged: fizzbuzz:latest
: Deleted: sha256:45468e2e8f882a61444888d407fab25f93c9670c5fe4096dc76801e9cf241ced
: Deleted: sha256:11088b4c74dff8accb7a2c72a3acf41709b6c44a9b25c8187738ade2b0f1452a
: Deleted: sha256:d6710223ee5a861c4a66cb8df4315952ca65ae5b6c70056e99bd8de0fec5990f
