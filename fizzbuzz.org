...
#+BEGIN_SRC python -n :results output :exports both :cache yes
  ...
  class Perceptron:
      def __init__(self, num_inputs):
          ...
          self.weights = [random.randint(-100,100)/100 for i in
                          range(num_inputs)]
      ...
      def activate(self, sum):
          """Activation function determines when the perceptron fires."""
          if sum > 0:
              return +1
          else:
              return -1
  ...
  class Network:
      def __init__(self, num_inputs, num_outputs):
          ...
          num_outputs denotes the number of perceptrons.
          """
          self.ptrons = []
          for i in range(num_outputs):
              self.ptrons.append(Perceptron(num_inputs))
              
          print("network: num inputs:", num_inputs, "num ptrons",
                len(self.ptrons))
...
#+RESULTS[1c6ffa0158b4eff79a7123c0def1983b6acb06f8]:
