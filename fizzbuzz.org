...
#+BEGIN_SRC python -n :results output :exports both :cache yes
  ...
  def training_network(training, ptron):    
      count = 0 #TODO
  ...
  def main():
      ...
      setup(training)
      for i in range(10):
          training_network(training, ptron)

      # Prüfen der Ergebnisse
      print("Gewichte", ptron.weights)
      for i in range(10):
          x = random.randint(-100, 100)
          y = random.randint(-100, 100)
          answer = 1
      ...
      for i in range(100):
          ...
          if y < f(x):
              answer = -1
          res = ptron.feedforward([x,y,1])        
          print(x,y,"a", answer, "ptron", res, "error", abs(answer-res))
...
#+RESULTS[97225ac2e112464b0f3f55abe5fa6db93d621ad7]:
#+begin_example
Anzahl Perceptrons 23
0 :0 (1)fizz (1)buzz (1)
1 :1 (1)
2 :2 (1)
3 :3 (1)fizz (1)
