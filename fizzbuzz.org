...
Das folgende Beispiel verwendet EA-Modul. Hierbei agiert ein Taster
als Sensor, der beim Drücken in das Topic =taster0/pressed= eine 1
oder 0 sendet - je nachdem, ob der Taster gedrückt oder losgelassen
wurde. Eine LED agiert als Sensor, die sich beim Topic registriert und
auf Nachrichten entsprechend reagiert.
