...
Ein typischer Ablauf wird z.B. bei [[https://guides.github.com/introduction/flow/][github]] vorgestellt. Dort gibt es
auch ein [[https://pel-daniel.github.io/git-init/index.html][interaktives Tutorial inklusive Spickzettel]].
...
Eine ausführliche Beschreibung befindet sich im [[https://packaging.python.org/][Python Packaging User
Guide]].
...
Andere Bots sind etwa [[http://errbot.io/][err]] oder der [[https://github.com/python-telegram-bot/python-telegram-bot][pyton-telegram-bot]].
...
[[https://matplotlib.org][matplotlib]] etabliert. In dem folgenden Beispiel wird die
  ...
  def main():
      ...
      for x in range(100):
          ...
          if isinstance(res, int):
              # the result was a number - not 'fizz', 'buzz' or 'fizzbuzz'.
              xs.append(x)
              ys.append(res)

      # clear all figures
      plt.clf()
      # turn on the grid and set title
      plt.grid(True)
      plt.title("Fizzbuzz")
      # create a plot made of x and y values and save as image
      plt.plot(xs, ys, "r.")
      plt.savefig("doc/fizzbuzz-plot.png")
...
#+RESULTS[e0e454ab59d233aaa2ee307fd37868ce036c54e5]:

Das Ergebnis könnte wie folgt aussehen.

file:doc/fizzbuzz-plot.png" 

Eine ausführliche Beschreibung mit Beispielen findet sich im Artikel
[[http://pbpython.com/effective-matplotlib.html][Effectively Using Matplotlib]].

* So schnell wie möglich

Die Anfrage [High Throughput FizzBuzz](https://codegolf.stackexchange.com/questions/215216/high-throughput-fizz-buzz)
beschreibt eine Implementierung, die möglichst schnell laufen soll.
