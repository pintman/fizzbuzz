...
[master (Basis-Commit) d2ce6e2] commit hallo.py
 1 file changed, 1 insertion(+)
 create mode 100644 hallo.py
commit d2ce6e2707dbf7f999459484f26cc6ae283c8f7b
Author: Marco Bakera <marco@bakera.de>
Date:   Sat Apr 29 13:16:26 2017 +0200

    commit hallo.py
[new_feature c2a187a] added new feature
 1 file changed, 1 insertion(+)
Aktualisiere d2ce6e2..c2a187a
Fast-forward
 hallo.py | 1 +
 1 file changed, 1 insertion(+)
#+end_example
